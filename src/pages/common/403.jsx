/*
 * @LastEditTime: 2022-05-03 04:17:17
 * @Description:
 * @Date: 2022-04-20 10:54:39
 * @Author: wangshan
 * @LastEditors: wangshan
 */
import './index.scss'

const bk = `<svg xmlns="http://www.w3.org/2000/svg" id="robot-error" viewBox="0 0 260 118.9">
            <defs>
...
export default function () {
    return (
        <div
            className="page_403"
            dangerouslySetInnerHTML={{ __html: bk }}
        ></div>
    )
}
